...
class LenovoSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        l.add_xpath("QuarterlyCDPScore", '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[4]/table/tr[7]/td[2]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyCDPScore", '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[4]/table/tr[7]/td[2]/a/text()', #CDP2 if there is a hyperlink
                    MapCompose(unicode.strip, unicode.title))
        ...
        l.add_xpath("QuarterlyLenovoOperatingProfit",'//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[14]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoNonOperatingExceptionalItems",'//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[15]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoAssociates", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[16]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoProfitBeforeTaxation", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[17]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoTaxation", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[18]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoProfitLossAfterTaxation", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[19]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoIncomeMinorityInterests", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[20]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoNetProfit", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[22]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoTotalDividend", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[23]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoRetainedProfitLoss", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[24]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoGrossProfit", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[25]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoTurnoverGrowth", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[29]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoEPSHKD", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[32]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoDilutedEPSHKD", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[33]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        ...
        l.add_xpath("QuarterlyLenovoReserves",
                    '//div[@id="balinterimdiv"]//*[@id="fs-table"]/tbody/tr[39]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoShareholdersFunds",
                    '//div[@id="balinterimdiv"]//*[@id="fs-table"]/tbody/tr[40]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        ...
        l.add_xpath("QuarterlyLenovoCashGeneratedFromOperations",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[1]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoNetCashFlowFromOperatingActivities",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[2]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoInterestRecieved",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[3]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoCashFlowInterestPaid",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[4]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoDividendsRecieved",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[5]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoDividendsPaid",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[6]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoTaxesPaidOrRefunded",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[7]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoAdditionsToFixedAssets",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[8]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoIncreaseInInvestments",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[9]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoDisposalOfFixedAssets",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[10]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoDecreaseInInvestments",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[11]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoNetCashFlowWithRelatedParties",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[12]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoNewLoans",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[13]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoLoansRepayment",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[14]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoFixedIncomeDebtInstruments",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[15]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoEquityFinancing",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[16]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoNetCashFlowWithRelatedParties2",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[17]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoNetEffectOfForeignExchangeRateChangesOthers",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[18]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoRepaymentOfFixedIncomeOrDebtInstruments",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[19]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoNetCashFlowFromFinancingActivities",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[20]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoNetCashFlowFromInvestingActivities",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[21]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoIncreaseDecreaseInCashAndCashEquivalents",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[22]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoCashAndCashEquivalentsAtBeginningOfYear",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[23]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLenovoCashAndCashEquivalentsAtEndOfYear",
                    '//div[@id="casinterimdiv"]//*[@id="fs-table"]/tbody/tr[24]/td[2]/span/text()',
                    MapCompose(unicode.strip, unicode.title))
        ...
        l.add_xpath("AnnualLenovoTurnoverGrowth",
                    ...
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("AnnualLenovoEPSHKD",
