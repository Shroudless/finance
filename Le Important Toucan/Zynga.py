...
class ZyngaSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        l.add_xpath("QuarterlyCDPScore",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[7]/td[2]/a/text()',
                    MapCompose(unicode.strip, unicode.title))
        ...
        l.add_xpath("AnnualCDPScore", '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[7]/td[3]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("AnnualCDPScore", '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[7]/a/td[3]/text()',
                    MapCompose(unicode.strip, unicode.title))
