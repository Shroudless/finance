...
class ZyngaSpider(scrapy.Spider):
    name = "Zynga"
    start_urls = (
        'https://www.google.com/finance?q=NASDAQ:ZNGA&fstype=ii',
        'https://www.google.com/finance?cid=481720736332929',
    )
    ...
    def parse(self, response):
        ...
        l.add_xpath("QuarterlyPeriod",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/thead/tr/td[2]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyNetProfitMargin",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[1]/td[2]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyOperatingMargin",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[2]/td[2]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyEBITDMargin",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[3]/td[2]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyReturnOnAssets",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[4]/td[2]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyReturnOnEquity",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[5]/td[2]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyEmployees",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[6]/td[2]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyCDPScore",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[7]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        ...
        l.add_xpath("AnnualPeriod", '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/thead/tr/td[2]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("AnnualNetProfitMargin",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[1]/td[3]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("AnnualOperatingMargin",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[2]/td[3]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("AnnualEBITDMargin",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[3]/td[3]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("AnnualReturnOnAssets",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[4]/td[3]/text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("AnnualReturnOnEquity",
                    '//*[@id="gf-viewc"]/div/div/div[3]/div[1]/div/div[6]/table/tr[5]/td[3]/text()',
                    MapCompose(unicode.strip, unicode.title))
        ...
        l.add_xpath("QuarterlyIncomeSheetCurrency",
        ...
        l.add_xpath("QuarterlyRevenue", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[1]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyOtherRevenueTotal",
        ...
        l.add_xpath("QuarterlyTotalRevenue", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[3]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyCostOfRevenueTotal",
        ...
        l.add_xpath("QuarterlySellingGeneralAdminExpensesTotal",
                    ...
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyResearchAndDevelopment",
        ...
        l.add_xpath("QuarterlyDepreciationAmortization",
                    ...
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyInterestExpenseIncome",
                    '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[9]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyUnusualExpenseIncome",
                    '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[10]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyOtherOperatingExpenses",
                    '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[11]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyTotalOperatingExpenses",
                    '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[12]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyOperatingIncome",
                    '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[13]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyInterestIncomeExpense",
        ...
        l.add_xpath("QuarterlyIncomeBeforeTax",
                    '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[17]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyIncomeAfterTax",
                    '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[18]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyMinorityInterest",
                    '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[19]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyEquityInAffiliates",
        ...
        l.add_xpath("QuarterlyNetIncomeBeforeExtraItems",
                    ...
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyAccountingChange",
                    '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[22]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyDiscontinuedOperations",
                    '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[23]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyExtraordinaryItem",
        ...
        l.add_xpath("QuarterlyNetIncome", '//div[@id="incinterimdiv"]//*[@id="fs-table"]/tbody/tr[25]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyPreferredDividends",
        ...
        l.add_xpath("QuarterlyBasicEPSIncludingExtraordinaryItems",
                    ...
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyDilutionAdjustment",
        ...
        l.add_xpath("QuarterlyDepreciationSupplemental",
                    ...
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyTotalSpecialItems",
        ...
        l.add_xpath("QuarterlyNormalizedIncomeAvailToCommon",
                    ...
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyBasicNormalizedEPS",
        ...
        l.add_xpath("AnnualIncomeStatementCurrency",
        ...
        l.add_xpath("QuarterlyBalanceTimePeriod",
                    '//div[@id="balinterimdiv"]//*[@id="fs-table"]/thead/tr/th[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyBalanceSheetCurrency",
                    '//div[@id="balinterimdiv"]//*[@id="fs-table"]/thead/tr/th[1]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyCashAndEquivalents",
                    '//div[@id="balinterimdiv"]//*[@id="fs-table"]/tbody/tr[1]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyShortTermInvestments",
        ...
        l.add_xpath("QuarterlyGoodwillNet", '//div[@id="balinterimdiv"]//*[@id="fs-table"]/tbody/tr[13]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyIntangiblesNet",
                    '//div[@id="balinterimdiv"]//*[@id="fs-table"]/tbody/tr[14]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyLongTermInvestments",
        ...
        l.add_xpath("QuarterlyTotalAssets", '//div[@id="balinterimdiv"]//*[@id="fs-table"]/tbody/tr[17]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyAccountsPayable",
                    '//div[@id="balinterimdiv"]//*[@id="fs-table"]/tbody/tr[18]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyAccruedExpenses",
        ...
        l.add_xpath("QuarterlyCapitalLeaseObligations",
                    ...
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyTotalLongTermDebt",
        ...
        l.add_xpath("QuarterlyPreferredStockNonRedeemableNet",
                    ...
                    MapCompose(unicode.strip, unicode.title))
        l.add_xpath("QuarterlyCommonStockTotal",
        ...
        l.add_xpath("QuarterlyOtherEquityTotal",
                    '//div[@id="balinterimdiv"]//*[@id="fs-table"]/tbody/tr[38]/td[2]//text()',
                    MapCompose(unicode.strip, unicode.title))
